...
- شاشة إضافة المنتج في Flutter تستخدم تمريرًا داخليًا صريحًا مع تعطيل سحب الـbottom sheet المتعارض معه، وتحجيم فك ترميز معاينة الصورة؛ هذا يمنع تعليق التمرير وثقل إعادة رسم الصورة في Flutter Web. نموذج الويب صفحة مستقلة ولا يستخدم bottom sheet، لذلك لا ينطبق عليه تعارض السحب نفسه.
