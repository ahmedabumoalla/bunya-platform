...
- نموذج إضافة المنتج في Flutter شاشة مستقلة كاملة عبر `Navigator` وليس bottom sheet؛ السبب هو منع تعارض سحب النافذة مع التمرير الطويل للنموذج على Flutter Web والجوال.
