...
- نموذج إضافة المنتج في Flutter نافذة سفلية احترافية عبر `DraggableScrollableSheet`. يجب تمرير `scrollController` الصادر من النافذة مباشرة إلى `ListView` داخل النموذج حتى يعمل السكرول على Flutter Web والجوال دون تعارض، مع الحفاظ على جميع حقول المنتج.
