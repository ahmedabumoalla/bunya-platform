...
const groups: readonly AdminNavGroup[] = [
  ...
  ["المالية", [["المالية والأرباح", "/admin/finance", "◉"], ["تصفيات المزودين", "/admin/settlements/providers", "⇄"], ["تصفيات المقاولين", "/admin/settlements/contractors", "⇄"], ["الفواتير والاسترجاعات", "/admin/invoices", "▧"]]],
